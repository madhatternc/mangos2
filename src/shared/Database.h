...
enum DatabaseError
{
    ...
    dbeWrongCredentials,
    // Connection to server unexpectedly closed or lost
    dbeConnectionLost,
...
public:
    /// The logger object associated with this database
    Log *Logger;
    ...
    /**
     * Query the error string corresponding to given error code.
     */
    ...
    /**
     * Return a executor to the pool of spare executors.
     * @arg dbEx
    ...
    /**
     * Set up the logger object used to log database errors.
     *
     */
