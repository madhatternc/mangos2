/**
 *     \file  src/shared/posix/ConsoleSysDep.cpp
 *    \brief  POSIX-specific console functions
 *
...
void Console::GetSize (int *Columns, int *Rows)
{
    ...
    // trust ioctl better than environment, which can be wrong
    // (especially if stdin/stdout are redirected to another
