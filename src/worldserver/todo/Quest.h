/**
 *     \file  src/worldserver/todo/Quest.h
 *    \brief  Provides basic Quest functions.
 *
...
class Quest
{
    public:
        ...
        // Quest Requirements
        uint32 m_originalGuid;                              // GUID of the original questgiving creature // only needed when m_targetGuid is filled out
        uint32 m_targetGuid;                                // GUID of a creature to speak with to complete the quest
