/**
 *     \file  src/worldserver/todo/Character.h
...
class Character : public Unit
{
    ...
    public:
        ...
        void Create ( uint32 guidlow, class NetworkPacket &data );
        ...
        inline std::list<struct actions> getActionList() { return m_actions; };
                                                            // added gb
        void addAction(uint8 button, uint16 action, uint8 type, uint8 misc);    void removeAction(uint8 button);
