...
enum RealmOpcodes
{
	...
	SMSG_UPDATE_INITIATE = 0x0030,
	SMSG_UPDATE_TRANSFER = 0x0031,
	CMSG_UPDATE_ACCEPT = 0x0032,
	CMSG_UPDATE_RESUME = 0x0033,
	CMSG_UPDATE_CANCEL = 0x0034
};
...
enum RealmErrors
{
	...
	CE_CANNOT_LOGIN = 0x8,
	CE_BAD_VERSION = 0x9,
	CE_UPDATE_CLIENT = 0xA,
	CE_UNKNOWN3 = 0xB,
	CE_ACCOUNT_FREEZED = 0xC,
	CE_UNKNOWN4 = 0xD,
	CE_UNKNOWN5 = 0xE,
	CE_PARENTAL_CONTROL = 0xF
};
...
class CMSG_RECONNECT_PROOF_t : public NetworkPacket 
{
public:
	uint8 A[32];
	uint8 M1[20];
	...
	static CMSG_RECONNECT_PROOF_t *Create (Socket *socket);
	bool Parse (Socket *socket);
};
