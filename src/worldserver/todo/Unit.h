/**
 *     \file  src/worldserver/todo/Unit.h
...
class Unit : public Object
{
    ...
    public:
        ...
        inline uint8 getLevel ()
            { return (uint8)Values->u32[ UNIT_FIELD_LEVEL ]; };
        inline uint8 getRace ()
            { return (uint8)Values->u32[ UNIT_FIELD_BYTES_0 ] & 0xFF; };
        inline uint8 getClass ()
            { return (uint8)(Values->u32[ UNIT_FIELD_BYTES_0 ] >> 8) & 0xFF; };
        inline uint8 getGender ()
            { return (uint8)(Values->u32[ UNIT_FIELD_BYTES_0 ] >> 16) & 0xFF; };
        /////////////////////////////////////////////////////////////////
