...
public:
    ...
    /**
     * Append the object to the array and increment object's
     * reference counter.
     */
    ...
    /**
     * Pick the top object from the array.
     * NOTE: THIS FUNCTION DOES NOT decrement object's reference counter
     */
    inline Base *Pop ()
