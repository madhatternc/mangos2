/**
 *     \file  src/worldserver/todo/Character.cpp
...
Character::Character () : Unit ()
{
    ...
    m_objectTypeId = 4;
    m_afk = 0;
    Values->u32[ OBJECT_FIELD_TYPE ] = m_objectType;
...
void Character::Create (uint32 guidlow, NetworkPacket& data)// (uint8 * data, uint16 length)
{
    ...
    if (class_ == WARRIOR)                                  // warrior
    {
        ...
        if (race == 1)                                      // Human
        {
                                                            ...
                                                            // recruit's shirt
            AddItemToSlot(3, WORLDSERVER.m_hiItemGuid++, 38);
                                                            // recruit's pants
            AddItemToSlot(6, WORLDSERVER.m_hiItemGuid++, 39);
                                                            // recruit's boots
            AddItemToSlot(7, WORLDSERVER.m_hiItemGuid++, 40);
                                                            // worn wooden shield
            AddItemToSlot(16, WORLDSERVER.m_hiItemGuid++, 2362);
                                                            // worn short sword
            AddItemToSlot(15, WORLDSERVER.m_hiItemGuid++, 25);
                                                            // Darnassian Bleu
            AddItemToSlot(23, WORLDSERVER.m_hiItemGuid++, 2070);
        }
        if (race == 2)                                      // Orc
        {
            // +3 strength
        ...
        if (race == 2)                                      // Orc
        {
            ...
            AddItemToSlot(15, WORLDSERVER.m_hiItemGuid++, 25);
                                                            // tough jerky
            AddItemToSlot(23, WORLDSERVER.m_hiItemGuid++, 117);
                                                            // tough hunk of bread
            AddItemToSlot(24, WORLDSERVER.m_hiItemGuid++, 4540);
        }
        if (race == 3)                                      // Dwarf
        {
            // +3 strength
        ...
        if (race == 4)                                      // Night Elf
        {
                                                            ...
                                                            // recruit's shirt
            AddItemToSlot(3, WORLDSERVER.m_hiItemGuid++, 6120);
                                                            // recruit's pants
            AddItemToSlot(6, WORLDSERVER.m_hiItemGuid++, 39);
                                                            // recruit's boots
            AddItemToSlot(7, WORLDSERVER.m_hiItemGuid++, 40);
        ...
        if (race == 5)                                      // Undead
        {
            ...
            AddItemToSlot(23, WORLDSERVER.m_hiItemGuid++, 117);
                                                            // forest mushroom cap
            AddItemToSlot(24, WORLDSERVER.m_hiItemGuid++, 4604);
        }
        if (race == 6)                                      // Tauren
        {
            // +3 strength
    ...
    else if (class_ == PALADIN)                             // Paladin
    {
        ...
        {
                                                            // squire's shirt
            AddItemToSlot(3, WORLDSERVER.m_hiItemGuid++, 45);
                                                            // squire's pants
            AddItemToSlot(6, WORLDSERVER.m_hiItemGuid++, 44);
                                                            // squire's boots
            AddItemToSlot(7, WORLDSERVER.m_hiItemGuid++, 43);
                                                            // battleworn hammer
            AddItemToSlot(15, WORLDSERVER.m_hiItemGuid++, 2361);
                                                            // refreshing spring water
            AddItemToSlot(23, WORLDSERVER.m_hiItemGuid++, 159);
                                                            // Darnassian Bleu
            AddItemToSlot(24, WORLDSERVER.m_hiItemGuid++, 2070);
        }
        if (race == 3)                                      // Dwarfs
        {
            // +2 Strenght
    ...
    else if (class_ == ROGUE)                               // Rogue
    {
        ...
        {
                                                            // Footpad’s shirt
            AddItemToSlot(3, WORLDSERVER.m_hiItemGuid++, 49);
                                                            // Footpad’s Pants
            AddItemToSlot(6, WORLDSERVER.m_hiItemGuid++, 48);
                                                            // Footpad’s shoes
            AddItemToSlot(7, WORLDSERVER.m_hiItemGuid++, 47);
                                                            // Worn dagger
            AddItemToSlot(15, WORLDSERVER.m_hiItemGuid++, 2092);
                                                            // tough hunk of bread
            AddItemToSlot(23, WORLDSERVER.m_hiItemGuid++, 4540);
                                                            // Darnassian Bleu
            AddItemToSlot(24, WORLDSERVER.m_hiItemGuid++, 2070);
        }
        if (race == 2)                                      // Orc
        ...
        if (race == 2)                                      // Orc
        {
            ...
            AddItemToSlot(23, WORLDSERVER.m_hiItemGuid++, 4540);
                                                            // tough jerky
            AddItemToSlot(24, WORLDSERVER.m_hiItemGuid++, 117);
        }
        if (race == 3)                                      // Dwarf
        {
            // +2 Strenght
        ...
        if (race == 5)                                      // Undead
        {
            ...
            AddItemToSlot(15, WORLDSERVER.m_hiItemGuid++, 2092);
                                                            // forest mushroom cap
            AddItemToSlot(23, WORLDSERVER.m_hiItemGuid++, 4604);
                                                            // forest mushroom cap
            AddItemToSlot(24, WORLDSERVER.m_hiItemGuid++, 4604);
        }
        if (race == 7)                                      // Gnome
    ...
    else if (class_ == PRIEST)                              // Priest
    {
        ...
        {
                                                            // neophytes's boots
            AddItemToSlot(7, WORLDSERVER.m_hiItemGuid++, 51);
                                                            // neophytes's pants
            AddItemToSlot(6, WORLDSERVER.m_hiItemGuid++, 52);
                                                            // neophyte's robe
            AddItemToSlot(4, WORLDSERVER.m_hiItemGuid++, 6098);
                                                            // neophyte's shirt
            AddItemToSlot(3, WORLDSERVER.m_hiItemGuid++, 53);
                                                            // worn mace
            AddItemToSlot(15, WORLDSERVER.m_hiItemGuid++, 36);
                                                            // Darnassian Bleu
            AddItemToSlot(23, WORLDSERVER.m_hiItemGuid++, 2070);
                                                            // refreshing spring water
            AddItemToSlot(24, WORLDSERVER.m_hiItemGuid++, 159);
        }
        if (race == 8)                                      // Troll
        {
            // +1 Stamina
        ...
        if (race == 8)                                      // Troll
        {
            ...
            AddItemToSlot(6, WORLDSERVER.m_hiItemGuid++, 52);
                                                            // neophyte's robe
            AddItemToSlot(4, WORLDSERVER.m_hiItemGuid++, 6144);
                                                            // neophyte's shirt
            AddItemToSlot(3, WORLDSERVER.m_hiItemGuid++, 53);
                                                            // worn mace
            AddItemToSlot(15, WORLDSERVER.m_hiItemGuid++, 36);
    ...
    else if (class_ == MAGE)                                // mage
    {
        ...
        {
                                                            // Apprentice’s Boots
            AddItemToSlot(7, WORLDSERVER.m_hiItemGuid++, 55);
                                                            // Apprentice’s Pants
            AddItemToSlot(6, WORLDSERVER.m_hiItemGuid++, 1395);
                                                            // Apprentice’s Robe
            AddItemToSlot(4, WORLDSERVER.m_hiItemGuid++, 56);
                                                            // Apprentice’s Shirt
            AddItemToSlot(3, WORLDSERVER.m_hiItemGuid++, 6096);
                                                            // bent staff
            AddItemToSlot(15, WORLDSERVER.m_hiItemGuid++, 35);
                                                            // Darnassian Bleu
            AddItemToSlot(23, WORLDSERVER.m_hiItemGuid++, 2070);
                                                            // refreshing spring water
            AddItemToSlot(24, WORLDSERVER.m_hiItemGuid++, 159);
        ...
        if (race == 8)                                      // Troll
        {
            ...
            AddItemToSlot(6, WORLDSERVER.m_hiItemGuid++, 1395);
                                                            // Apprentice’s Robe
            AddItemToSlot(4, WORLDSERVER.m_hiItemGuid++, 6140);
                                                            // Apprentice’s Shirt
            AddItemToSlot(3, WORLDSERVER.m_hiItemGuid++, 6096);
                                                            // bent staff
            AddItemToSlot(15, WORLDSERVER.m_hiItemGuid++, 35);
    ...
    else if (class_ == WARLOCK)                             // Warlock
    {
        ...
        {
                                                            // acolyte's shoes
            AddItemToSlot(7, WORLDSERVER.m_hiItemGuid++, 59);
                                                            // acolyte's pants
            AddItemToSlot(6, WORLDSERVER.m_hiItemGuid++, 1396);
                                                            // acolyte's robe
            AddItemToSlot(4, WORLDSERVER.m_hiItemGuid++, 57);
                                                            // worn dagger
            AddItemToSlot(15, WORLDSERVER.m_hiItemGuid++, 2092);
                                                            // tough jerky
            AddItemToSlot(23, WORLDSERVER.m_hiItemGuid++, 117);
                                                            // refreshing spring water
            AddItemToSlot(25, WORLDSERVER.m_hiItemGuid++, 159);
                                                            // Darnassian Bleu
            AddItemToSlot(24, WORLDSERVER.m_hiItemGuid++, 2070);
        }
        if (race == 2)                                      // Orc
        ...
        if (race == 2)                                      // Orc
        {
            ...
            AddItemToSlot(6, WORLDSERVER.m_hiItemGuid++, 1396);
                                                            // acolyte's robe
            AddItemToSlot(4, WORLDSERVER.m_hiItemGuid++, 6129);
                                                            // worn dagger
            AddItemToSlot(15, WORLDSERVER.m_hiItemGuid++, 2092);
                                                            // tough jerky
            AddItemToSlot(23, WORLDSERVER.m_hiItemGuid++, 117);
    ...
    else if (m_respawnTimer > 0)
    {
        ...
        if(m_respawnTimer <= 0)
        {
            ...
            uint32 xp = getUpdateValue(PLAYER_XP);
                                                            // Fixed float - Torg
            uint32 xpt = (uint32) (100 * getLevel() * (float) pow((float)getLevel(), (float)1.2));
            int32 newxp = xp - xpt;
            if(newxp < 0)
            {
            ...
            uint32 money = getUpdateValue(PLAYER_FIELD_COINAGE);
                                                            // Fixed float - Torg
            uint32 moneyt = (uint32)(100 * (float) pow((float)getLevel(), (float)1.2));
...
void Character::giveStat()
{
    ...
    switch (getClass())
    {
        case SHAMAN:
        {
            if(level>4)
            {
                m_stat4 +=1; m_stat1 +=1; przyrost1=1; przyrost4=1;
            }
        ...
        case WARLOCK:
        {
            ...
            if(level > 9)
            {
                if(level %2 ==0)
                {
                    m_stat0 +=1; m_stat2 +=1; przyrost0=1; przyrost2=1;
                }
            }
        ...
        case WARRIOR:
        {
            if(level > 1)
            {
                m_stat0 +=1; przyrost0=1; m_stat1 +=1; przyrost1=1;
            }
            if(level > 6)
            {
                if(level %2 !=0)
            ...
            if(level > 9)
            {
                if(level % 2==0)
                {
                    m_stat3 +=1; m_stat4 +=1; przyrost3=1; przyrost4=1;
                }
            }
...
void Character::LoadUpdateValues(uint8* data)
{
    ...
    Values->u32[0] = atol(next);
    for (uint16 index = 1; index < UPDATE_BLOCKS; index++)
    {
        char* next = strtok(NULL, " ");
        if (!next) continue;
        Values->u32[index] = atol(next);
        //        assert(Values->u32[index] != 0x7FFFFFFF);
    }

    Values->u32[UNIT_FIELD_NATIVEDISPLAYID] = Values->u32[UNIT_FIELD_DISPLAYID];
}
    ...
    for(int i=0; i < 20; i++)
    {
        if (this->m_items[i].guid > 1)
        {
            ...
            tArmor += Stat;
                                                            ...
                                                            // unknown
            Stat = WORLDSERVER.GetItem(m_items[i].itemid)->Resistances[1];
            tRes1 += Stat;
